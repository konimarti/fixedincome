...
func TestMaturities(t *testing.T) {
	...
	testData := []struct {
	...
	}{
		{
			...
			Frequency:         1,
			Expected:          []float64{8.005, 7.0, 6.0, 5.0, 4.0, 3.0, 2.0, 1.0},
			ExpectedFrequency: 1,
			ExpectedRemaining: 8.005,
		},
		{
			Quote:             time.Date(2021, 01, 01, 0, 0, 0, 0, time.UTC),
			Maturity:          time.Date(2029, 01, 01, 0, 0, 0, 0, time.UTC),
			Frequency:         2,
			Expected:          []float64{8.005, 7.5, 7.0, 6.5, 6.0, 5.5, 5.0, 4.5, 4.0, 3.5, 3.0, 2.5, 2.0, 1.5, 1.0, 0.5},
			ExpectedFrequency: 2,
			ExpectedRemaining: 8.005,
		},
		{
